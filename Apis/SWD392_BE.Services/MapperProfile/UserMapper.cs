...
namespace SWD392_BE.Services.MapperProfile
{
    public class UserMapper : Profile
    {
        public UserMapper()
        {
            ...
            CreateMap<CreateVoucherModel, Voucher>().ReverseMap();

            // Area
            CreateMap<CreateAreaRequestModel, Area>()
            ...
            CreateMap<UpdateAreaRequestModel, Area>()
            .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status))
            .ForMember(dest => dest.CreatedDate, opt => opt.Ignore())
            .ForMember(dest => dest.CreatedBy, opt => opt.Ignore())
            ...
            // Campus
            CreateMap<CreateCampusRequestModel, Campus>()
            .ForMember(dest => dest.CampusId, opt => opt.MapFrom(src => src.CampusId))
            .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
            .ForMember(dest => dest.AreaId, opt => opt.MapFrom(src => src.AreaId))
            .ForMember(dest => dest.CreatedDate, opt => opt.Ignore())
            ...
            CreateMap<UpdateCampusRequestModel, Campus>()
            .ForMember(dest => dest.AreaId, opt => opt.MapFrom(src => src.AreaId))
            .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status))
            .ForMember(dest => dest.CreatedDate, opt => opt.Ignore())
